...
<html>
	<head>
		...
		<script type="text/javascript" src="/ExamSignUp/resources/js/CitySignUpInfoFJ.js"></script>
		<style type="text/css">
.icon-grid {
...
.pIcon {
	...
	<body>
		<div style = "display:none">
  			<form name ="exportCitySignUpInfoFJ" id = "exportCitySignUpInfoFJ" action = "" target = "export" method ="post" accept-charset="UTF-8"></form>
