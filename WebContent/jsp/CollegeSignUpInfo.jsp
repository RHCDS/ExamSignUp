...
<html>
	<head>
		...
		<script type="text/javascript" src="/ExamSignUp/resources/ext/ext-all.js"></script>
  		...
  		<script type='text/javascript' src='/ExamSignUp/dwr/interface/CollegeController.js'></script>
		...
		<script type="text/javascript" src="/ExamSignUp/resources/js/CollegeSignUpInfo.js"></script>
		<style type="text/css">
.icon-grid {
...
.pIcon {
	...
	<body>
		     <div style = "display:none">
	  			<form name ="exportYXBMTJB" id = "exportYXBMTJB" action = "" target = "export" method ="post" accept-charset="UTF-8"></form>
		...
		<script type="text/javascript">
			...
			this.collegeSignUpInfoPageInit(institution);
  		</script>
	</body>
