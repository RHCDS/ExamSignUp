...
<html>
	<head>
		...
		<script type="text/javascript" src="/ExamSignUp/resources/js/CityExportCJ.js"></script>
		<style type="text/css">
.icon-grid {
...
.pIcon {
	...
	<body>
		...
		<form name ="exportAllSchoolCJDBF" id = "exportAllSchoolCJDBF" action = "" target = "export" method ="post" accept-charset="UTF-8"></form>
