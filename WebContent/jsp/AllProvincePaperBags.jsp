...
<html>
	<head>
		...
		<script type="text/javascript" src="/ExamSignUp/resources/js/AllProvincePaperBags.js"></script>
		<style type="text/css">
.icon-grid {
...
.pIcon {
	...
	<body>
		<div style = "display:none">
  			<form name ="exportProvincePaperBags" id = "exportProvincePaperBags" action = "" target = "export" method ="post" accept-charset="UTF-8"></form>
