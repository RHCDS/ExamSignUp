...
<html>
	<head>
		...
		<script type="text/javascript" src="/ExamSignUp/resources/js/ExportOneSchoolStudentCJ.js"></script>
		<style type="text/css">
.icon-grid {
...
.pIcon {
	...
	<body>
		...
		<form name ="exportOneSchoolCJDbf" id = "exportOneSchoolCJDbf" action = "" target = "export" method ="post" accept-charset="UTF-8"></form>
