...
<html>
	<head>
		...
		<script type="text/javascript" src="/ExamSignUp/resources/custom/DwrProxy.js"></script>
   		...
   		<script type="text/javascript" src="/ExamSignUp/dwr/interface/InstitutionstatusController.js"></script>
		<script type="text/javascript" src="/ExamSignUp/resources/js/SchoolStuInfoCheck.js"></script>
		<style type="text/css">
.icon-grid {
...
<script type="text/javascript">
			Ext.onReady(function(){
				var username ="<%=session.getAttribute("managerName")%>";
				this.initPage(username);
			});
  		</script>
	</body>
