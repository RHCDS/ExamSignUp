...
<html>
	<head>
		...
		<script type="text/javascript" src="/ExamSignUp/resources/js/BackUpStuInfo.js"></script>
		<style type="text/css">
.icon-grid {
...
.pIcon {
	...
	<body>
		...
		<form name ="exportBackupStudentsExcel" id = "exportBackupStudentsExcel" action = "" target = "export" method ="post" accept-charset="UTF-8"></form>
		<iframe name="export" id="export"></iframe>
		</div>
		<script type="text/javascript">
			Ext.onReady(function(){
				this.backUpStudentsInfo();
			});
  		</script>
	</body>
