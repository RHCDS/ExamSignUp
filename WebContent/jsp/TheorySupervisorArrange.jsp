...
<html>
	<head>
		...
		<script type='text/javascript' src='/ExamSignUp/dwr/interface/TheorySupervisorArrangeController.js'></script>
		<script type='text/javascript' src='/ExamSignUp/resources/js/TheorySupervisorArrange.js'></script>	
		<style type="text/css">
.icon-grid {
