...
<html>
	<head>
		...
		<script type="text/javascript" src="/ExamSignUp/resources/ext/ext-all.js"></script>
 		...
 		<script type='text/javascript' src='/ExamSignUp/dwr/interface/ParameterController.js'></script>
		<script type="text/javascript" src="/ExamSignUp/resources/custom/DwrProxy.js"></script>
		<script type="text/javascript" src="/ExamSignUp/resources/js/StudentPicPath.js"></script>
		<style type="text/css">
.icon-grid {
