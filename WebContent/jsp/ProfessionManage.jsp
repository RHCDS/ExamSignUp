...
<html>
	<head>
		...
		<script type='text/javascript' src='/ExamSignUp/dwr/engine.js'></script>
 		...
 		<script type='text/javascript' src='/ExamSignUp/dwr/interface/ProfessionController.js'></script>
		<script type="text/javascript" src="../resources/custom/DwrProxy.js"></script>
		<script type="text/javascript" src="../resources/js/ProfessionManage.js"></script>
		<style type="text/css">
.icon-grid {
