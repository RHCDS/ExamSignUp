...
<html>
	<head>
		...
		<script type='text/javascript' src='/ExamSignUp/dwr/interface/SectionController.js'></script>
		<script type='text/javascript' src='/ExamSignUp/resources/js/SectionManage.js'></script>		
		<style type="text/css">
.icon-grid {
