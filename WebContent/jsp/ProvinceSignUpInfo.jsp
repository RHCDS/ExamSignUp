...
<html>
	<head>
		...
		<script type="text/javascript" src="/ExamSignUp/resources/js/SchoolSignUpInfo.js"></script>
		<script type="text/javascript" src="/ExamSignUp/resources/js/ProvinceSignUpInfo.js"></script>
		<style type="text/css">
.icon-grid {
...
.pIcon {
	...
	<body>
		<div style = "display:none">
  			<form name ="exportOneSchoolDbf" id = "exportOneSchoolDbf" action = "" target = "export" method ="post" accept-charset="UTF-8"></form>
  			<iframe name="export" id="export"></iframe>
  		</div>
  		<div style = "display:none">
  			<form name ="exportAllSchoolDbf" id = "exportAllSchoolDbf" action = "" target = "export" method ="post" accept-charset="UTF-8"></form>
  			<iframe name="export" id="export"></iframe>
  		</div>
		<script type='text/javascript'>
			Ext.onReady(function(){
				var institution ="<%=session.getAttribute("institution")%>";
				this.provinceSignUpInfoInit(institution);
			});
  		</script>
	</body>
