...
<script type="text/javascript"
    ...
    <script type='text/javascript' src='/ExamSignUp/dwr/interface/UploadPicturesController.js'></script>
	<script type="text/javascript" src="/ExamSignUp/resources/custom/DwrProxy.js"></script>
	<script type="text/javascript" src="/ExamSignUp/resources/js/UploadPictures.js"></script>
	<style type="text/css">
.icon-grid {
...
.export-icon {
	background: url(../resources/icons/data.gif) no-repeat 0 0
		!important;
}
