...
<html>
	<head>
		...
		<script type='text/javascript' src='/ExamSignUp/dwr/interface/OperateSupervisorArrangeController.js'></script>
		<script type='text/javascript' src='/ExamSignUp/resources/js/OperateSupervisorArrange.js'></script>	
		<style type="text/css">
.icon-grid {
