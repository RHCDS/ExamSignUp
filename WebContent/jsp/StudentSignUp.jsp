	...
	<body>
		<script language="javascript">
			Ext.onReady(function(){
				...
				var studentnum ="<%=session.getAttribute("studentID")%>"; 
				this.StudentSignUpPageInit(studentnum);
    			StudentController.getStudentPhotoPathByStudentNum(studentnum,function(filepath){
    				Ext.getCmp("photo").getEl().dom.src = filepath;
    			});
			});
  		</script>
	</body>
