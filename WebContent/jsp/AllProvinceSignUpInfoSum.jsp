...
<html>
	<head>
		...
		<script type="text/javascript" src="/ExamSignUp/resources/js/AllProvinceSignUpInfoSum.js"></script>
		<style type="text/css">
.icon-grid {
...
.pIcon {
	...
	<body>
		<div style = "display:none">
  			<form name ="exportAllProvinceSignUpInfoSum" id = "exportAllProvinceSignUpInfoSum" action = "" target = "export" method ="post" accept-charset="UTF-8"></form>
		...
		<script language="javascript">
			Ext.onReady(function(){
				...
				var ByLanguage = true;
				this.SchoolStateManageInit(institution,ByLanguage);
			});
  		</script>
	</body>
