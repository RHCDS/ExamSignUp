...
<html>
	<head>
		...
		<script type="text/javascript" src="/ExamSignUp/resources/ext/ext-all.js"></script>
  		...
  		<script type='text/javascript' src='/ExamSignUp/dwr/interface/UserController.js'></script>
		...
		<script type="text/javascript" src="/ExamSignUp/resources/js/InstitutionManage.js"></script>
		<style type="text/css">
.icon-grid {
...
<script type="text/javascript">
			Ext.onReady(function(){
				var studentidnum ="<%=session.getAttribute("institution")%>";
				this.cityInstitutionPageInit(studentidnum);
			});
  		</script>
	</body>
