...
<html>
	<head>
		...
		<script type="text/javascript" src="/ExamSignUp/resources/js/ScoreSummaryByGrade_College.js"></script>
		<style type="text/css">
.icon-grid {
...
.pIcon {
	...
	<div style = "display:none">
	  			<form name ="exportNJYXCJTJBExcel" id = "exportNJYXCJTJBExcel" action = "" target = "export" method ="post" accept-charset="UTF-8"></form>
	  			<iframe name="export" id="export"></iframe>
	  		</div>
		<script type="text/javascript">		
			Ext.onReady(function(){		
				this.ScoreSummaryInfoPageInit();							
			});
  		</script>
