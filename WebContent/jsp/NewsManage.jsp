...
<html>
	<head>
		...
		<script type='text/javascript' src='/ExamSignUp/dwr/engine.js'></script>
 		...
 		<script type='text/javascript' src='/ExamSignUp/dwr/interface/NewsManageController.js'></script>
		<script type="text/javascript" src="../resources/custom/DwrProxy.js"></script>
		<script type="text/javascript" src="../resources/js/NewsManage.js"></script>
		<style type="text/css">
.icon-grid {
