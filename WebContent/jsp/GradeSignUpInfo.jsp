...
<html>
	<head>
		...
		<script type="text/javascript" src="/ExamSignUp/resources/js/GradeSignUpInfo.js"></script>
...
.pIcon {
	...
	<body>
	        <div style = "display:none">
	  			<form name ="exportNJBMTJB" id = "exportNJBMTJB" action = "" target = "export" method ="post" accept-charset="UTF-8"></form>
		...
		this.gradeSignUpInfoPageInit(institution);
