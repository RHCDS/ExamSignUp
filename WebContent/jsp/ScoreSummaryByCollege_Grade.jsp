...
<html>
	<head>
		...
		<script type="text/javascript" src="/ExamSignUp/resources/js/ScoreSummaryByCollege_Grade.js"></script>
		<style type="text/css">
.icon-grid {
...
.pIcon {
	...
	<div style = "display:none">
	  			<form name ="exportYXNJCJTJBExcel" id = "exportYXNJCJTJBExcel" action = "" target = "export" method ="post" accept-charset="UTF-8"></form>
