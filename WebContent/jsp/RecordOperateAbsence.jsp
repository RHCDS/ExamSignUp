...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/ExamSignUp/resources/css/MultiSelect.css" />
		...
		<script type='text/javascript' src='/ExamSignUp/resources/js/MultiSelect.js'></script>
		<script type='text/javascript' src='/ExamSignUp/resources/js/ItemSelector.js'></script>
		...
		<script type='text/javascript' src='/ExamSignUp/dwr/interface/OperateExamArrangeController.js'></script>
		<script type='text/javascript' src='/ExamSignUp/resources/js/RecordOperateAbsence2.js'></script>	
		<style type="text/css">
.icon-grid {
...
.pIcon {
	...
	<body>
		...
		<div style = "display:none">
  			<form name ="exportStudentsOperateAbsentExcel" id = "exportStudentsOperateAbsentExcel" action = "" target = "export" method ="post" accept-charset="UTF-8"></form>
