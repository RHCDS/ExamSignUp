...
var examabsencestore = new Ext.data.Store( {
	...
	proxy : new Ext.ux.data.DWRProxy({
	     dwrFunction : StudentController.absentStudentAllSchools  //用于考试院查看所有高校缺考信息
	  })
});
...
function exportAbsentStudentsXls(){
	var f = document.getElementById('exportAllSchoolsAbsentExcel');
	f.action = '../exportAllSchoolsAbsentExcel.do';
	f.submit({
