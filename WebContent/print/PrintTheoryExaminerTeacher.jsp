...
<head>
		...
		<script type="text/javascript" src="../resources/js/PrintTheoryExaminerTeacher.js"></script>
...
function CreatePrintPage(InfoArray) {		  	  
    LODOP.NEWPAGE();	 
    LODOP.PRINT_INITA(0,0,"210mm","297mm","打印理论监考教师名单");
  ...
  /*function CreatePrintPage(strTableHTML) {	
	  ...
	  LODOP.NEWPAGE();	 
	  LODOP.ADD_PRINT_TEXT(29,20,700,150,"浙江省高校计算机等级考试理论监考教师名单");	  
	  LODOP.SET_PRINT_STYLEA(0,"FontSize",25);
	  LODOP.SET_PRINT_STYLEA(0,"Alignment",2);
	  LODOP.SET_PRINT_STYLEA(0,"Bold",1);  
	  LODOP.ADD_PRINT_TABLE(80,-25,800,900,strTableHTML);
	  LODOP.SET_PRINT_STYLEA(0,"Alignment",2);
...
Ext.onReady(function(){
	this.printTheoryExaminerTeacherPageInit();
});
</script>
